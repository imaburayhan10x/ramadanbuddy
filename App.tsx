...
const MainApp: React.FC = () => {
  ...
  return (
    <div className="min-h-screen max-w-md mx-auto bg-gray-50 dark:bg-gray-900 shadow-2xl overflow-hidden relative border-x border-gray-200 dark:border-gray-800 transition-colors duration-300">
      <main className="h-full overflow-y-auto no-scrollbar">
        {renderScreen()}
      </main>
      
      {/* Hide bottom nav if on Profile or Admin screen */}
